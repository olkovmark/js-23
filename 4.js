...
class Portfolio {
  ...
  readElements() {
    this.elements.forEach((value) => {
      if (value instanceof Letter) return this.readLetter(value);
      if (value instanceof Picture) return this.readPicture(value);
      if (value instanceof Movie) return this.readMovie(value);
      console.log("message");
    });
  }
